  ...
  function node_modulesFirebaseAuthDistAuthEsmJs(module, __webpack_exports__, __webpack_require__) {
    ...
    (function () {
      ...
      da("Promise", function (a) {
        ...
        b.race = function (g) {
          return new b(function (h, m) {
            for (var p = fa(g), u = p.next(); !u.done; u = p.next()) {
              d(u.value).La(h, m);
            }
          });
        };
        ...
        b.all = function (g) {
          ...
          return m.done ? d([]) : new b(function (p, u) {
            ...
            do {
              C.push(void 0), N++, d(m.value).La(A(C.length - 1), u), m = h.next();
            } while (!m.done);
          });
        };
      ...
      function hc(a, b, c, d) {
        if (c == Wb && b.b && !b.c) for (; a && a.g; a = a.c) {
          a.g = !1;
        }
      ...
      function Xc(a, b, c, d, e) {
        if (d && d.once) Yc(a, b, c, d, e);else if (oa(b)) for (var f = 0; f < b.length; f++) {
          Xc(a, b[f], c, d, e);
      ...
      function rd(a, b) {
        if (a.forEach && "function" == typeof a.forEach) a.forEach(b, void 0);else if (pa(a) || n(a)) x(a, b, void 0);else for (var c = qd(a), d = pd(a), e = d.length, f = 0; f < e; f++) {
      ...
      function sd(a, b) {
        ...
        } else if (a) if (a instanceof sd) for (c = a.X(), d = 0; d < c.length; d++) {
      ...
      function td(a) {
        ...
        if (a.c != a.a.length) {
          ...
          for (c = b = 0; b < a.a.length;) {
            d = a.a[b], ud(e, d) || (a.a[c++] = d, e[d] = 1), b++;
          }
      ...
      k.X = function () {
        ...
        for (var a = this.a.U(), b = this.a.X(), c = [], d = 0; d < b.length; d++) {
        ...
        if (null == b) c.push("null");else {
          if ("object" == typeof b) {
            ...
            if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf();else {
              ...
              for (d in b) {
                Object.prototype.hasOwnProperty.call(b, d) && (f = b[d], "function" != typeof f && (c.push(e), ee(d, c), c.push(":"), ce(a, f, c), e = ","));
              }
      ...
      */
      ...
      function ke(a, b) {
        ...
        for (d in a) {
          d in b ? typeof a[d] != typeof b[d] ? c.push(d) : "object" == typeof a[d] && null != a[d] && null != b[d] ? 0 < ke(a[d], b[d]).length && c.push(d) : a[d] !== b[d] && c.push(d) : c.push(d);
        }
      ...
      function Be() {
        return _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.INTERNAL.hasOwnProperty("reactNative") ? "ReactNative" : _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.INTERNAL.hasOwnProperty("node") ? "Node" : Ae() ? "Worker" : "Browser";
      }
      ...
      function Se() {
        ...
        return Re() || !a ? D() : new B(function (c) {
          _b = function b() {
            Re() && (a.removeEventListener("visibilitychange", _b, !1), c());
          };
      ...
      function Qf() {
        if (!Mf) {
          ...
          for (var a = 0; 65 > a; a++) {
            Mf[a] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(a), Nf[Mf[a]] = a, 62 <= a && (Nf["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(a)] = a);
          }
        }
      }
      ...
      */
      ...
      qh.prototype.log = function (a, b, c) {
        if (a.value >= wh(this).value) for (q(b) && (b = b()), a = new oh(a, String(b), this.f), c && (a.a = c), c = this; c;) {
          c = c.a;
        }
      };
      ...
      */
      ...
      uj.prototype.toString = function () {
        ...
        if (this.a.isOAuthProvider) {
          ...
          try {
            var c = _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.app(this.c).auth().ha();
          } catch (h) {
            c = null;
          }
        ...
        if (this.b) for (var g in this.b) {
          this.b.hasOwnProperty(g) && !Ld(a, g) && H(a, g, this.b[g]);
        }
      ...
      function vj(a) {
        try {
          return _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.app(a).auth().Ca();
        } catch (b) {
          return [];
        }
      }
      ...
      function bk() {
        ...
        this.a = dk() || _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.INTERNAL.node.localStorage;
      ...
      function ck() {
        var a = "Node" == Be();
        a = dk() || a && _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.INTERNAL.node && _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.INTERNAL.node.localStorage;
        if (!a) return !1;
      ...
      function fk() {
        ...
        this.a = hk() || _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.INTERNAL.node.sessionStorage;
      ...
      function gk() {
        var a = "Node" == Be();
        a = hk() || a && _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.INTERNAL.node && _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.INTERNAL.node.sessionStorage;
        if (!a) return !1;
      ...
      for (var Fk = 64, Ik = Fk - 1, Jk = [], Kk = 0; Kk < Ik; Kk++) {
        Jk[Kk] = 0;
      }
      ...
      function Nk(a, b, c) {
        ...
        var d = 0,
            e = a.c;
        if (n(b)) for (; d < c;) {
          a.f[e++] = b.charCodeAt(d++), e == a.b && (Mk(a), e = 0);
      ...
      function Q(a, b, c) {
        ...
        a = _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.SDK_VERSION ? Fe(_firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.SDK_VERSION) : null;
      ...
      function Ul(a, b) {
        a.P = b;
        vi(a.a, _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.SDK_VERSION ? Fe(_firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.SDK_VERSION, a.P) : null);
      }
      ...
      k.zc = function (a) {
        ...
        for (var b = mm(a), c = 0; c < b.length; c++) {
          fm(this, b[c]);
        }
      ...
      function qm(a, b, c, d, e) {
        ...
        var f = $f(c.providerId),
            g = He(a.uid + ":::"),
            h = null;
        (!Ke() || ze()) && a.o && c.isOAuthProvider && (h = Cj(a.o, a.l, a.m, b, c, null, g, _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.SDK_VERSION || null, null, null, a.tenantId));
      ...
      function Fm(a, b) {
        ...
        for (d in ok) {
          ok[d] !== b && c.push(wk(a.b, Dm(ok[d]), a.a));
        }
      ...
      function Lm(a) {
        ...
        K(this, "app", a);
        if (S(this).options && S(this).options.apiKey) a = _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.SDK_VERSION ? Fe(_firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.SDK_VERSION) : null, this.b = new oi(S(this).options && S(this).options.apiKey, Vf(Wf), a);else throw new M("invalid-api-key");
        this.O = [];
        this.m = [];
        this.J = [];
        this.Ub = _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.INTERNAL.createSubscribe(t(this.oc, this));
        this.W = void 0;
        this.Vb = _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.INTERNAL.createSubscribe(t(this.pc, this));
        Mm(this, null);
      ...
      k.vc = function (a) {
        this.I.push(a);
        vi(this.b, _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.SDK_VERSION ? Fe(_firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.SDK_VERSION, this.I) : null);
      ...
      k.Lc = function (a) {
        ...
        var b = this,
            ...
            d = He(),
            e = null;
        (!Ke() || ze()) && S(this).options.authDomain && a.isOAuthProvider && (e = Cj(S(this).options.authDomain, S(this).options.apiKey, S(this).name, "signInViaPopup", a, null, d, _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.SDK_VERSION || null, null, null, this.R()));
      ...
      function xn(a, b, c) {
        ...
        f = _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.SDK_VERSION ? Fe(_firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.SDK_VERSION, f) : null;
      ...
      Z(kg, "fromJSON", function (a) {
        ...
        for (var b, c = [vg, Mg, Tg, sg], d = 0; d < c.length; d++) {
          if (b = c[d](a)) return b;
        }
      ...
      (function () {
        if ("undefined" !== typeof _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a && _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.INTERNAL && _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.INTERNAL.registerComponent) {
          ...
          _firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.registerVersion("@firebase/auth", "0.13.5");
